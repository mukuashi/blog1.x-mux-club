...
<head>
    ...
    <link rel="stylesheet" href="http://kquanr.com/mall/themes/default/__RESOURCE__/css/base.css" type="text/css"/>
    ...
    <div class="row ptb10">
        <div class="col-xsl-2">
            <a href="<?php echo mobile_url('goodlist')?>">
                <img class="img-responsive" src="http://kquanr.com/mall/themes/default/__RESOURCE__/images/t1.jpg" style="display: inline;">
                <span>全部商品</span>
            </a>
        </div>
        <div class="col-xsl-2">
            <a href="<?php echo mobile_url('myorder',array('status'=>99))?>">
                <img class="img-responsive" src="http://kquanr.com/mall/themes/default/__RESOURCE__/images/t6.png" style="display: inline;">
                <span>我的订单</span>
            </a>
        </div>
        ...
        <div class="col-xsl-2">
            <a href="<?php echo mobile_url('bonus')?>">
                <img class="img-responsive" src="http://kquanr.com/mall/themes/default/__RESOURCE__/images/t5.png" style="display: inline;">
                <span>优惠券</span>
            </a>
        </div>
        ...
        <div class="col-xsl-2">
            <a href="<?php echo mobile_url('help')?>">
                <img class="img-responsive" src="http://kquanr.com/mall/themes/default/__RESOURCE__/images/t2.png" style="display: inline;">
                <span>购物须知</span>
            </a>
        </div>
