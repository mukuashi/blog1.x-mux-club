...
$(document).ready(function() {
  ...
  $("#callme").on("click", function() {
    if (
      ...
      layer.alert(
        '亲，在手机里面打开可以直接操作哟 <br>请搜索 <a href="http://weixin.sogou.com/weixin?type=1&query=PhotoArtLife&ie=utf8&_sug_=n&_sug_type_=" target="_blank">PhotoArtLife</a>',
        { icon: 6 }
      );
      return false;
    }
  ...
  $(".alone").on("click", function(event) {
    location.href =
      "http://weixin.sogou.com/weixin?type=2&query=PhotoArtLife&ie=utf8&_sug_=n&_sug_type_=";
    /* Act on the event */
  });
  //微信提示框
  //1-公共微信
  $(".wechat").on("click", function() {
    layer.open({
      ...
      area: ["350px", "410px"], //宽高
      content:
        '<div class="img_wechat"><img src="http://kquanr.com/1.x/images/wechat-public.jpg" alt="请检查您的网络连接哟"><p>微信公众号ID：PhotoArtLife<br>如有问题，可以给我留言哈</p></div>'
    });
  });
  //2-个人微信
  $(".private-wechat").on("click", function() {
    layer.open({
      ...
      area: ["350px", "410px"], //宽高
      content:
        '<div class="img_wechat"><img src="http://kquanr.com/1.x/images/wechat-private.jpg" alt="请检查您的网络连接哟"><p>作者微信ID：mukuashi<br>如有问题，可以给我留言哈。</p></div>'
    });
  });
  //避免HTML5表单提交失败的验证
