					...
					<div class="logcontrol">
						<div class="control-group">
							...
							<i class="fa fa-user"></i>
								<input class="input-xlarge" type="text" name="args[username]" datatype="userName" needle="needle" msg="请输入您的用户名" placeholder="请输入您的用户名"/><span>记住用户名的格式哟</span>
							</div>
						</div>
						<div class="control-group">
							...
							<i class="fa fa-expeditedssl"></i>
								<input class="input-xlarge" type="password" name="args[userpassword]" datatype="password" needle="needle" msg="请您输入密码" placeholder="请输入您的密码"/><span>密码长度6位以上，数字、字母或其他字符</span>
							</div>
						</div>
						<div class="control-group">
							<div class="controls">
