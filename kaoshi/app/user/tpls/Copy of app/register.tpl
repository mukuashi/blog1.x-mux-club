					...
					<div class="logcontrol">
						<div class="control-group">
							...
							<i class="fa fa-user"></i>
								<input class="input-xlarge" type="text" type="text" name="args[username]" datatype="userName" needle="needle" msg="请输入您的用户名"/><span>不允许出现非法字符</span>
							</div>
						</div>
						<div class="control-group">
							...
							<i class="fa fa-envelope"></i>
								<input class="input-xlarge" type="text" name="args[useremail]" datatype="email" needle="needle" msg="请输入您的邮箱"/><span>请输入可用的电子邮箱地址</span>
							</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							<input id="checkbox" type="checkbox" name="agree" checked="checked"/>
								<p class="reg">我已经认真阅读并同意遵守本站<a href="javascript" id="reg_xy"> 用户协议和隐私政策 </a> 如果您已有帐号，请在此<a href="index.php?user-app-login">登录</a>
								</p>
							</div>
						</div>
					</div>
