...
Zzx.prototype ={
	init:function(){
		...
		this.stack = 0;
		//图片路径
		this.imgPath = '../image/people/';		
		//定时器
		this.timer = null;
		//测试JSON数据（可以替换为AJAX请求返回值）
		this.testJson = {
						list:[
								{src:"1.jpg",title:"P2P和非法集资的模糊边界",song:"fm1"},
								{src:"2.jpg",title:"编制给我们的思考",song:"fm2"},
								{src:"3.jpg",title:"听李开复谈死神修学分",song:"fm3"},
								{src:"4.jpg",title:"为什么强者阿里与苏宁要联姻呢？",song:"fm4"},
								{src:"5.jpg",title:"中国的经济信任道路",song:"fm5"},
								{src:"6.jpg",title:"咱们的政府负债数据",song:"fm6"},
								{src:"1.jpg",title:"人民币国际化的作用",song:"fm7"},
								{src:"2.jpg",title:"真正的考场从来不在学校",song:"fm8"},
								{src:"3.jpg",title:"在多维世界里思考互联网思维",song:"fm9"},
								{src:"4.jpg",title:"后发优势之从零到一",song:"fm10"},
								{src:"5.jpg",title:"在绝望中寻找希望之俞敏洪",song:"fm11"},
								{src:"6.jpg",title:"你的生命有什么可能",song:"fm12"}
							]
						}
	...
	loadDate:function(oList){			
		switch(this.type){  
			...
			case 1:this.ulTarget.append('<li onclick="myControl.selectList(this,'+this.stack+')">'
									  ...
									  + '<div class="textBox">'+oList[this.stack].title+'<p>智客干货子标题</p></div>'
									  + '</li>');
										break;
...
var Control = function(o){
	...
	this.path            = 'http://mkstest-93zm.stor.sinaapp.com/';  //歌曲路径（相对于html）
	this.imgPath         = '../image/people/';   //图片路径（相对于html）
	this.init();
}
