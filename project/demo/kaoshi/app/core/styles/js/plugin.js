...
$(document).ready(function($) {
    ...
    area: ['420px', '540px'], //宽高
    content: '<div class="reg_1"><p>1:用户应当同意本协议的条款并按照页面上的提示完成全部的注册程序，用户在进行注册程序过程中点击"同意"按钮即表示用户与九三智盟公司达成协议，完全接受本协议项下的全部条款用户应当同意本协议的条款并按照页面上的提示完成全部的注册程序。</p><p>2：用户在进行注册程序过程中点击"同意"按钮即表示用户与九三智盟公司达成协议，完全接受本协议项下的全部条款用户应当同意本协议的条款并按照页面上的提示完成全部的注册程序。</p><p>3：用户在进行注册程序过程中点击"同意"按钮即表示用户与九三智盟公司达成协议，完全接受本协议项下的全部条款用户应当同意本协议的条款并按照页面上的提示完成全部的注册程序。</p><p>4：用户在进行注册程序过程中点击"同意"按钮即表示用户与九三智盟公司达成协议，完全接受本协议项下的全部条款用户应当同意本协议的条款并按照页面上的提示完成全部的注册程序。</p><p>5：用户在进行注册程序过程中点击"同意"按钮即表示用户与九三智盟公司达成协议，完全接受本协议项下的全部条款用户应当同意本协议的条款并按照页面上的提示完成全部的注册程序。</p><p>6：用户在进行注册程序过程中点击"同意"按钮即表示用户与九三智盟公司达成协议，完全接受本协议项下的全部条款用户应当同意本协议的条款并按照页面上的提示完成全部的注册程序。</p><p>7：用户在进行注册程序过程中点击"同意"按钮即表示用户与九三智盟公司达成协议，完全接受本协议项下的全部条款</p></div>'
    });
    });
});
