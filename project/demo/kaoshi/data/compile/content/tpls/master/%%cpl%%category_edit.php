...
<div class="container-fluid">
	<div class="row-fluid">
		...
		<div class="span10" id="datacontent">
			...
			<ul class="nav nav-tabs">
				...
				<li class="pull-right">
					<a href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-category&parent=<?php echo $this->tpl_var['category']['catparent']; ?>">分类列表</a>
				</li>
			</ul>
			<form action="index.php?<?php echo $this->tpl_var['_app']; ?>-master-category-edit" method="post" class="form-horizontal">
				<fieldset>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="args[catindex]" value="<?php if($this->tpl_var['category']['catindex']){ ?><?php echo $this->tpl_var['category']['catindex']; ?><?php } else { ?>0<?php } ?>" datatype="number" needle="needle" msg="您必须填写展示内容条数"> 条
 ...
 $tid++; ?>
						...
						<div class="controls">
							<div class="thumbuper pull-left">
								<div class="thumbnail">
									...
									<div class="boot"><img src="<?php if($this->tpl_var['category']['catimg']){ ?><?php echo $this->tpl_var['category']['catimg']; ?><?php } else { ?>app/core/styles/images/noimage.gif<?php } ?>" id="catimg_view"/><input type="hidden" name="args[catimg]" value="<?php echo $this->tpl_var['category']['catimg']; ?>" id="catimg_value"/></div>
								</div>
							</div>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							<textarea class="input-xxlarge ckeditor" rows="7" id="catdes" name="args[catdes]"><?php echo html_entity_decode($this->ev->stripSlashes($this->tpl_var['category']['catdes'])); ?></textarea>
