...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http://kquanr.com/mall/themes/default/__RESOURCE__/recouse/css/fcommom.css?version=20150713">
    <link rel="stylesheet" type="text/css" href="http://kquanr.com/mall/themes/default/__RESOURCE__/recouse/css/fd.css">
    <style>
        .foot {
            width: 100%;
            min-width: 300px;
...
<div class="panel memberhead">
    <div class="header-l"><?php if(empty($avatar)){?><img class="icon-level-p1"
                                                                src="http://kquanr.com/mall/themes/default/__RESOURCE__/recouse/images/tx.png"/><?php }else{ ?><img
