...
<head>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		<title><?php  echo empty($settings['shop_title'])?'UJNShop小猿城':$settings['shop_title'];?></title>
		<link rel="shortcut icon" href="favicon.ico" type="image/x-icon" />
		<meta name="description" content="<?php  echo empty($settings['shop_description'])?'UJNShop小猿城':$settings['shop_description'];?>" />
		<meta name="keywords" content="<?php  echo empty($settings['shop_keyword'])?'UJNShop小猿城':$settings['shop_keyword'];?>">
     <link href="<?php echo RESOURCE_ROOT;?>/addons/common/bootstrap3/css/bootstrap.min.css" rel="stylesheet" />
    <link type="text/css" rel="stylesheet" href="<?php echo RESOURCE_ROOT;?>/addons/common/fontawesome/css/font-awesome.min.css" />
   ...
   <link rel="stylesheet" href="<?php echo RESOURCE_ROOT;?>/addons/index/css/ace/ace.min.css" />
    ...
    <!--[if IE 7]>
    <link rel="stylesheet" href="<?php echo RESOURCE_ROOT;?>/addons/common/fontawesome/font-awesome-ie7.min.css">
    <![endif]-->
...
<div class="navbar-header pull-left">
    <a href="#" class="navbar-brand" style="height:45px">
        <small>
            ...
            <span id='accountname'>UJNShop小猿城</span>
        </small>
    </a><!-- /.brand -->
</div>
<div class="navbar-header pull-left">
        ...
        <div class="sidebar" id="sidebar">
          ...
          <ul class="nav nav-list">
            ...
            <div class="sidebar-collapse" id="sidebar-collapse">
                <i class="icon-angle-left" data-icon1="icon-angle-left" data-icon2="icon-angle-right"></i>
            </div>
