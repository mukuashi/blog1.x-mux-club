...
<body>
	...
	<div class="login">
		...
		<div class="login-inner">
			<h1 class="login-title">UJNShop小猿城</h1>
			<div class="login-item mgb20">
				<input type="text" class="clearError"  name="username"  id="ipt_account" placeholder="请输入管理员登录账号" tabindex="1">
				<a href="javascript:;" class="clearIpt j-clearIpt"><i class="gicon-remove"></i></a>
			</div>
			<div class="login-item mgb20">
				<input type="password" class="clearError" name="password" id="ipt_pwd" placeholder="请输入您的密码" tabindex="2">
				<a href="javascript:;" class="clearIpt j-clearIpt"><i class="gicon-remove"></i></a>
			</div>
			<div class="login-item mgb20">
					<input type="text" class="clearError" name="verify" id="ipt_code" placeholder="请输入验证码" data-autohide="1" tabindex="3">
					<a href="javascript:;" class="clearIpt j-clearIpt"><i class="gicon-remove"></i></a>
			</div>
			<div class="mgb20">
		...
		<p class="copyright"> kquanr.com&copy;PhotoArtLife </p>
	</div>
	<!-- end login -->
   </form>
