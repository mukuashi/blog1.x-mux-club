/* KindEditor 4.1.10 (2013-11-23), Copyright (C) kindsoft.net, Licence: http://www.kindsoft.net/license.php */ (function (
  ...
  function Rb(a, b, c) {
    a.addEventListener
      ? a.addEventListener(b, c, fb)
      : a.attachEvent && a.attachEvent("on" + b, c);
  }
  function za(a, b, c) {
    a.removeEventListener
      ? a.removeEventListener(b, c, fb)
  ...
  function Ca(a, b) {
    ...
    function g(a, b, c) {
      ...
      if (c.getElementsByClassName) {
        ...
        e = e.querySelectorAll(
          (c.nodeName !== "#document" ? c.nodeName + " " : "") + b + "." + a
        );
        h = 0;
    ...
    function h(a, b, d, e) {
      for (
        var g = [], d = e.getElementsByTagName(d), h = 0, f = d.length;
        h < f;
        h++
      )
        (e = d[h]),
  ...
  function Xb(a, b) {
    var c = W(a),
      ...
      e = "";
    c.getComputedStyle
      ? ((c = c.getComputedStyle(a, null)),
        (e = c[d] || c.getPropertyValue(b) || a.style[d]))
      : a.currentStyle && (e = a.currentStyle[d] || a.style[d]);
    return e;
  }
  function G(a) {
    a = a || document;
  ...
  function ca(a) {
    var a = a || document,
      b;
    o || Yb || Pa
      ? ((b = G(a).scrollLeft), (a = G(a).scrollTop))
      : ((b = W(a).scrollX), (a = W(a).scrollY));
    return { x: b, y: a };
  }
  function D(a) {
    this.init(a);
  ...
  function Qa(a, b, c) {
      ...
      for (var i = e.firstChild, o; i; ) {
        ...
        if (n > 0)
          if (i.nodeType == 1)
            ...
            ((i =
              i == k.startContainer
                ? d(i, k.startOffset, i.nodeValue.length)
                : i == k.endContainer
                ? d(i, 0, k.endOffset)
                : d(i, 0, i.nodeValue.length)),
            b)
          )
            try {
              l.appendChild(i);
    ...
    if (l.nodeType == 3)
      return (
        (l = d(l, a.startOffset, a.endOffset)),
        b && i.appendChild(l),
        e(),
        b ? i : a
      );
  ...
  function sb(a, b) {
    ...
    for (var q = 0, r = g.length; q < r; q++) {
      ...
      if (i.nodeType == 1) {
        ...
        i.nodeType == 3 &&
          (n.moveStart("character", i.nodeValue.length),
          (j += i.nodeValue.length));
      k < 0 && (h = i);
    }
    if (k < 0 && h.nodeType == 1)
      return { node: e, offset: f(e.lastChild).index() + 1 };
    ...
    if (a.type === 1 && ((b = wb(b)), b[c])) {
      for (var c = b[c].split(","), b = !1, d = 0, e = c.length; d < e; d++) {
        ...
        var h = /^(\.?)([^=]+)(?:=([^=]*))?$/.exec(g),
          g = h[2];
        h[1]
          ? ((g = ga(g)), a[0].style[g] && (a[0].style[g] = ""))
          : a.removeAttr(g);
      }
      b && a.remove(!0);
    }
  ...
  function zb(a) {
    a.nodeName &&
      ((a = V(a)), (a = Ra(a).selectNodeContents(a.body).collapse(!1)));
    return new oa(a);
  }
  function Wa(a) {
    var b = a.moveEl,
      ...
      if (a.useContextmenu) {
        if (a._contextmenus.length !== 0) {
          var c = 0,
            d = [];
          for (
            m(a._contextmenus, function () {
              if (this.title == "-") d.push(this);
              else if (
                this.cond &&
                this.cond() &&
                (d.push(this), this.width && this.width > c)
              )
                c = this.width;
            });
      ...
      f(c).keydown(function (f) {
        if (!(f.which != 13 || f.shiftKey || f.ctrlKey || f.altKey)) {
          ...
          j == "marquee" ||
            ...
            (d === "br" && !e[j]
              ? (f.preventDefault(),
                b.insertHtml("<br />" + (o && A < 9 ? "" : "\u200b")))
              : g[j] || Q(c, "formatblock", "<p>"));
        }
      });
      f(c).keyup(function (e) {
        if (
          !(e.which != 13 || e.shiftKey || e.ctrlKey || e.altKey) &&
          d != "br"
        )
          if (Y) {
            ...
            j &&
              j.text() == "" &&
              (j.remove(!0),
              b.cmd.range.selectNodeContents(e[0]).collapse(!0),
              b.cmd.select());
          } else if (
            (b.cmd.selection(),
            (e = a(b.cmd.range)),
    ...
    f(b).keydown(function (c) {
      if (c.which == 9)
        if ((c.preventDefault(), a.afterTab)) a.afterTab.call(a, c);
          ...
          d.shrink();
          d.collapsed &&
            d.startContainer.nodeType == 1 &&
            (d.insertNode(f("@&nbsp;", b)[0]), c.select());
          a.insertHtml("&nbsp;&nbsp;&nbsp;&nbsp;");
        }
    });
  }
  function dc() {
    var a = this;
    f(a.edit.textarea[0], a.edit.win)
      .focus(function (b) {
  ...
  function Kb(a, b) {
    ...
    c.designMode
      ? (c.html(h.html), h.start && (e.moveToBookmark(h), this.select()))
      : f(d).html(T(h.html));
    return this;
  }
  function ua(a) {
    ...
    if ((d = f(a)) && d.length !== 0) {
      ...
      bb(
        e.langPath +
          e.langType +
          ".js?ver=" +
          encodeURIComponent(f.DEBUG ? Ga : Ha),
        function () {
          c(e);
        }
      );
  ...
  if (!w.KindEditor) {
    ...
    var Ha = "4.1.10 (2013-11-23)",
      ...
      H = !w.getSelection,
      A = (p = /(?:msie|firefox|webkit|opera)[\/:\s](\d+)/.exec(p))
        ? p[1]
        : "0",
      Ga = new Date().getTime(),
      R = Math.round,
    ...
    f.basePath = (function () {
      for (
        var a = document.getElementsByTagName("script"), b, c = 0, d = a.length;
        c < d;
        c++
      )
    ...
    E(gb, {
      init: function (a, b) {
        ...
        if (
          !c.which &&
          (c.charCode || c.charCode === 0 ? c.charCode : c.keyCode)
        )
    ...
    E(D, {
      init: function (a) {
        for (var a = Z(a) ? a : [a], b = 0, c = 0, d = a.length; c < d; c++)
          a[c] && ((this[c] = a[c].constructor === D ? a[c][0] : a[c]), b++);
        this.length = b;
        this.doc = V(this[0]);
        this.name = Oa(this[0]);
      ...
      after: function (a) {
        this.each(function () {
          this.nextSibling
            ? this.parentNode.insertBefore(f(a)[0], this.nextSibling)
            : this.parentNode.appendChild(f(a)[0]);
        });
        return this;
      },
      ...
      children: function () {
        ...
        for (var a = [], b = this[0].firstChild; b; )
          (b.nodeType != 3 || B(b.nodeValue) !== "") && a.push(b),
            (b = b.nextSibling);
        return new D(a);
      },
      first: function () {
    ...
    E(M, {
      ...
      commonAncestor: function () {
        ...
        for (
          var b = a(this.startContainer),
            c = a(this.endContainer),
            d = 0,
            e = b.length,
            g = c.length,
            f,
      ...
      selectNodeContents: function (a) {
        ...
        b = b.children();
        if (b.length > 0)
          return this.setStartBefore(b[0]).setEndAfter(b[b.length - 1]);
        ...
        b.nodeType == 1
          ...
          : b.nodeType == 3 &&
            (c === 0
              ...
              : ((j = c > 0 ? b.splitText(c) : b),
                b.parentNode.insertBefore(a, j),
                b === d && ((d = j), (e -= c))));
          ...
          a.nodeType == 3 &&
            (d === 0
              ...
              : d == a.nodeValue.length &&
                (e ? b.setStartAfter(a) : b.setEndAfter(a)));
        }
        var b = this;
        a(b.startContainer, b.startOffset, !0);
        a(b.endContainer, b.endOffset, !1);
      ...
      shrink: function () {
        for (
          var a, b = this.collapsed;
          this.startContainer.nodeType == 1 &&
          (a = this.startContainer.childNodes[this.startOffset]) &&
          a.nodeType == 1 &&
          !f(a).isSingle();
      ...
      moveToBookmark: function (a) {
        ...
        c.remove();
        a && a.length > 0
          ? (this.setEndBefore(a[0]), a.remove())
          : this.collapse(!0);
        return this;
      },
      dump: function () {
    ...
    E(oa, {
      ...
      selection: function (a) {
        ...
        c =
          H && (!d || (!d.item && d.parentElement().ownerDocument !== b))
            ? null
            : d;
        this.sel = Sa(b);
        if (c)
          return (
            (this.range = Ra(c)),
            f(this.range.startContainer).name == "html" &&
              this.range.selectNodeContents(b.body).collapse(!1),
            this
          );
      ...
      select: function (a) {
        ...
        if (a && d.nodeType == 1 && c.collapsed) {
          ...
          if (
            ...
            ((a = d.childNodes),
            f(d).isInline() ||
              (e > 0 && f(a[e - 1]).isInline()) ||
              (a[e] && f(a[e]).isInline()))
          )
            c.insertNode(g.createTextNode("\u200b")), (k = !0);
        }
        if (H)
          try {
            (j = c.get(!0)), j.select();
          ...
          k && c.collapse(!1),
            ...
            b.addRange(j),
            g !== document &&
              ((c = f(j.endContainer).pos()), h.scrollTo(c.x, c.y));
        h.focus();
        return this;
      },
      wrap: function (a) {
          ...
          if (!g && a == e.start) g = !0;
            ...
            a: {
              for (d = b; d && d.name != "body"; ) {
                if (
                  La[d.name] ||
                  (d.name == "div" && d.hasClass("ke-script"))
                ) {
                  d = !0;
                  break a;
                }
            ...
            if (!d && b.type == 3 && B(a.nodeValue).length > 0) {
              for (
                var n;
                (n = b.parent()) && n.isStyle() && n.children().length == 1;
              ...
              if (b.type == 3) Va(n).append(b.clone(!1)), b.replaceWith(n);
                ...
                for (
                  var a = b, i;
                  (i = b.first()) && i.children().length == 1;

                )
                  b = i;
                i = b.first();
                for (b = b.doc.createDocumentFragment(); i; )
                  b.appendChild(i[0]), (i = i.next());
                i = a.clone(!0);
                d = Va(i);
                for (var r = i, l = !1; n; ) {
                  for (; r; )
                    r.name === n.name && (Zb(r, n.attr(), n.css()), (l = !0)),
                      (r = r.first());
      ...
      split: function (a, b) {
        for (
          var c = this.range,
            d = c.doc,
            e = c.cloneRange().collapse(a),
            g = e.startContainer,
            h = e.startOffset,
            j = g.nodeType == 3 ? g.parentNode : g,
            k = !1,
            n;
          j && j.parentNode;
        ...
        if (k)
          (d = d.createElement("span")),
            ...
            a
              ? e.setStartBefore(j.firstChild).setEnd(g, h)
              : e.setStart(g, h).setEndAfter(j.lastChild),
            (g = e.extractContents()),
            (h = g.firstChild),
            (k = g.lastChild),
            a
              ? (e.insertNode(g), c.setStartAfter(k).setEndBefore(d))
              : (j.appendChild(g), c.setStartBefore(d).setEndBefore(h)),
            (e = d.parentNode),
            e == c.endContainer &&
              ((j = f(d).prev()),
              (g = f(d).next()),
              j && g && j.type == 3 && g.type == 3
                ? c.setEnd(j[0], j[0].nodeValue.length)
                : a || c.setEnd(c.endContainer, c.endOffset - 1)),
            e.removeChild(d);
        return this;
      },
      remove: function (a) {
        ...
        if (c.startOffset === 0) {
          for (
            var d = f(c.startContainer), e;
            (e = d.parent()) && e.isStyle() && e.children().length == 1;
        ...
        if (d > 0) {
          ...
          i &&
            ea(i) &&
            (i.remove(), c.setStart(b, d - 1), b == e && c.setEnd(e, n - 1));
      ...
      val: function (a) {
        ...
        if (a === "fontsize")
          return (
            (a = this.commonNode({ "*": ".font-size" })) &&
              (c = a.css("font-size")),
            c.toLowerCase()
          );
        if (a === "forecolor")
          return (
            (a = this.commonNode({ "*": ".color" })) && (c = a.css("color")),
            (c = ya(c)),
            c === "" && (c = "default"),
            c.toLowerCase()
          );
        if (a === "hilitecolor")
          return (
            (a = this.commonNode({ "*": ".background-color" })) &&
      ...
      createlink: function (a, b) {
        ...
        if (
          ...
          g === j &&
          h + 1 === e &&
          ((e = g.childNodes[h]), e.nodeName.toLowerCase() == "a")
        )
          return c(e, a, b), this;
      ...
      unlink: function () {
        ...
        if (b.collapsed) {
          ...
          Q(a, "unlink", null);
          X &&
            f(b.startContainer).name === "img" &&
            ((a = f(b.startContainer).parent()),
            a.name === "a" && a.remove(!0));
    ...
    E(qa, S, {
      init: function (a) {
        function b() {
          ...
          X &&
            f(b).click(function (a) {
              f(a.target).name === "img" &&
                (k.selection(!0), k.range.selectNode(a.target), k.select());
            });
          if (o)
            (c._mousedownHandler = function () {
              ...
              f(b).keydown(function (a) {
                if (a.which == 8) {
                  ...
                  b.isControl() &&
                    (b.collapse(!0),
                    f(b.startContainer.childNodes[b.startOffset]).remove(),
                    a.preventDefault());
                }
              });
          c.cmd = k;
        ...
        var d = l(a.themesPath, ""),
          ...
          k =
            "document.open();" +
            (j ? 'document.domain="' + document.domain + '";' : "") +
            "document.close();",
          k = o
      ...
      html: function (a, b) {
        ...
        if (this.designMode) {
          ...
          if (a === i)
            return (
              (a = b
                ? "<!doctype html><html>" + c.parentNode.innerHTML + "</html>"
                : c.innerHTML),
    ...
    E(Da, S, {
      ...
      disableAll: function (a, b) {
        ...
        b && (d = u(b));
        (a === i ? !c.disableMode : a)
          ? (f("span.ke-outline", c.div).each(function () {
              var a = f(this),
    ...
    E(ra, S, {
      ...
      addItem: function (a) {
        if (a.title === "-")
          ...
          var h;
          this.centerLineMode &&
            ((h = f('<div class="ke-inline-block ke-menu-item-center"></div>')),
            e && h.css("height", e));
        ...
        b.bind("load", function () {
          ...
          try {
            ...
            a.options.afterError.call(
              a,
              "<!doctype html><html>" + c.body.parentNode.innerHTML + "</html>"
            );
          }
    ...
    E(ta, S, {
      init: function (a) {
        ...
        o && A < 7
          ...
          : b && f('<div class="ke-dialog-shadow"></div>').appendTo(this.div);
        b = f('<div class="ke-dialog-header"></div>');
        i.append(b);
        b.html(c);
        this.closeIcon = f(
          '<span class="ke-dialog-icon-close" title="' + j.name + '"></span>'
        ).click(j.click);
    ...
    f.tabs = function (a) {
      var b = Ya(a),
        ...
        a = b.div,
        e = [];
      a.addClass("ke-tabs").bind(
        "contextmenu,mousedown,mousemove",
        function (a) {
          a.preventDefault();
        }
      );
    ...
    ua.prototype = {
      ...
      create: function () {
        ...
        if (b._fullscreenResizeHandler)
          f(w).unbind("resize", b._fullscreenResizeHandler),
        ...
        c
          ? ((b._fullscreenResizeHandler = function () {
            ...
            f(w).bind("resize", b._fullscreenResizeHandler),
            h.select("fullscreen"),
            k.first().css("visibility", "hidden"),
            k.last().css("visibility", "hidden"))
          : (Y &&
              f(w).bind("scroll", function () {
                b._scrollPos = ca();
              }),
            b.resizeType > 0
              ? Wa({
      ...
      resize: function (a, b, c) {
        ...
        if (
          a &&
          (/%/.test(a) ||
            ((a = t(a)), (a = a < this.minWidth ? this.minWidth : a)),
          this.container.css("width", s(a)),
          c)
        )
          this.width = s(a);
        if (
          ...
          ((b = t(b)),
          (editHeight =
            t(b) - this.toolbar.div.height() - this.statusbar.height()),
          (editHeight =
            editHeight < this.minHeight ? this.minHeight : editHeight),
      ...
      addBookmark: function (a) {
        ...
        if (
          ...
          Math.abs(
            d.length -
              T(this._undoStack[this._undoStack.length - 1].html).length
          ) < this.minChangeSize
        )
          return this;
        b.designMode && !this._firstAddBookmark
          ? ((b = this.cmd.range),
            (a = b.createBookmark(!0)),
            (a.html = Fa(c.innerHTML)),
            b.moveToBookmark(a))
          : (a = { html: d });
      ...
      createMenu: function (a) {
        ...
        a.selectedColor !== i
          ? ((a.cls = "ke-colorpicker-" + this.themeType),
            (a.noColor = this.lang("noColor")),
            (this.menu = Db(a)))
          : ((a.cls = "ke-menu-" + this.themeType),
            (a.centerLineMode = !1),
            (this.menu = $a(a)));
        return this.menu;
      },
      ...
      hideDialog: function () {
        ...
        this.dialogs.length > 0 &&
          this.dialogs[0].setMaskIndex(
            this.dialogs[this.dialogs.length - 1].z - 1
          );
        return this;
      },
    ...
    Gb("core", function (a) {
      ...
      b.clickToolbar("about", function () {
        var a =
          ...
          Ha +
          '</div><div>Copyright &copy; <a href="//www.kindsoft.net/" target="_blank">kindsoft.net</a> All rights reserved.</div></div>';
        b.createDialog({
          name: "about",
          width: 350,
          title: b.lang("about"),
      ...
      b.afterCreate(function () {
        function c() {
          ...
          f.select();
          X &&
            (a("div." + l, i).each(function () {
              a(this).after("<br />").remove(!0);
            }),
            a("span.Apple-style-span", i).remove(!0),
            a("span.Apple-tab-span", i).remove(!0),
            a("span[style]", i).each(function () {
          ...
          i.remove();
          d !== "" &&
            (X && (d = d.replace(/(<br>)\1/gi, "$1")),
            b.pasteType === 2 &&
              ((d = d.replace(/(<(?:p|p\s[^>]*)>) *(<\/p>)/gi, "")),
              /schemas-microsoft-com|worddocument|mso-\w+/i.test(d)
                ? (d = nb(d, b.filterMode ? b.htmlTags : a.options.htmlTags))
                : ((d = U(d, b.filterMode ? b.htmlTags : null)),
                  (d = b.beforeSetHtml(d)))),
            b.pasteType === 1 &&
              ((d = d.replace(/&nbsp;/gi, " ")),
              (d = d.replace(/\n\s*\n/g, "\n")),
      ...
      b.beforeGetHtml(function (a) {
        ...
        return a
          ...
          .replace(
            ...
            function (a, b, c) {
              return (
                "<noscript" + unescape(b) + ">" + unescape(c) + "</noscript>"
              );
            }
          )
          .replace(
