...
(function ($) {
  $.fn.SmohanPopLayer = function (options) {
    ...
    if (options.Shade == true) {
      layerhtml +=
        '<div class="Smohan_Layer_Shade" style="display:none;"></div>';
    }
    layerhtml +=
      '<div class="Smohan_Layer_box" style="width:' +
      layer_width +
      "px;height:" +
      layer_height +
      "px; margin-top:-" +
...
$(document).ready(function (e) {
  ...
  share_html +=
    '<li title="分享到腾讯微博"><a href="javascript:void(0)" class="share4"></a><span></span></li>';
  share_html +=
    '<li title="分享到微信好友"><a href="javascript:void(0)" class="share5"></a><span></span></li>';
  share_html +=
    '<li title="分享到微信朋友圈"><a href="javascript:void(0)" class="share6"></a><span></span></li>';
  share_html += "</ul></div>";
  ...
  var share_pic = "/jiacheng/img/slider/slider_img_02.jpg"; //默认的分享图片
  ...
  $("#Share li a.share5").click(function (e) {
    layer.open({
      ...
      area: ["350px", "420px"], //宽高
      content:
        '<div class="img_wechat"><img src="http://www.kquanr.com/jiacheng/img/wechat.jpg" alt="请检查您的网络连接哟"><p>您好,欢迎来到山东嘉诚人力官方微信平台，您可以在线查看最新消息哟！</p></div>',
    });
  });
  //weixin_circles
