...
// owl
    ...
    // testimonail carosel
    // -------------------------------------------------------------
//parter之Owl Carousel强大的响应式jQuery焦点图轮播插件演示
    (function () {
        $('#owl-example').owlCarousel({
            loop:true,
            margin:0,
            autoPlay:2000, //设置自动播放间隔周期为2s
            dots:false,
            responsive:{
                320:{
                    items:2
   ...
   $( ".dropdown" ).hover(function() {
    ...
    $(".dropdown-menu").animate({top: "32px"}, function(){$(".dropdown-menu").animate({top: "20px"});});
    });
